...
class RecentContactPage extends StatefulWidget {
  ...
  const RecentContactPage({super.key, required this.controller});

  @override
  State<RecentContactPage> createState() => _RecentContactPageState();
}
...
class _RecentContactPageState extends State<RecentContactPage> {
  ...
  load() async {
    ...
    await widget.controller.getWithFilter(FilterType.recents);
